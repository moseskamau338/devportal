...
export default{
  ...
  setup(){
    ...
    let fields = ref([
      {key:'invoice_ref', label:'Invoice/Bank Ref'},
      {key:'date', label:'Date'},
      {key:'currency', label:'Currency'},
      {key:'amount', label:'Amount'},
      {key:'reconciled_amount', label:'Reconciled Amount'},
      {key:'gl_account', label:'GL/Bank Account'},
    ...
    let records = ref([
      {invoice_ref:'', date:'', currency:'', amount:0, reconciled_amount:0, gl_account:'', customer:'', recon_status:'', source:''},
    ])
    ...
    return {rowClicked, fields, records}
  }
}
