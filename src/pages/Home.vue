   ...
   <TabGroup as="div" vertical class="md:min-h-[300px] mt-8 md:mx-20 md:grid md:grid-cols-2">
      ...
      <TabPanels as="div" class="border rounded-md p-4">
        ...
        <TabPanel>
          ...
          <p class="prose-base text-lg">You can connect your accounting system and pull in invoice or bank data. Alternatively, you can upload formatted records and speed up the process.</p>
