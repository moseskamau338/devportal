  ...
  <section class="grid grid-cols-1 lg:grid-cols-2 gap-3 lg:gap-0 min-h-screen w-screen bg-white relative">
    ...
    <div class="w-full px-4 md:pl-32 xl:px-32">
      <nav class="flex justify-between lg:justify-end px-6 py-6">
        ...
        <a href="#" class="font-bold hover:underline">Signin</a>
      </nav>
                ...
                <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                 ...
                 <div class="sm:col-span-6 mb-5">
                  ...
                  <div class="flex flex-row space-x-5 items-center justify-center w-full mt-5 mb-14">
                    ...
                    <button class="flex flex-row items-center font-bold justify-center space-x-5 bg-blue-600 text-white px-3 py-2 rounded shadow-sm hover:opacity-80 transition-all">
        ...
        <!--  panel 2 company-->
              <div v-show="steps === 2" class="pt-6">
                ...
                <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                  ...
                  <div class="sm:col-span-3">
                    <label for="city" class="block text-sm font-medium text-gray-700"> Which banks have you integrated to?</label>
                    <div class="mt-1">
